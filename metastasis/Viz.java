...
import static HAL.Util.GetAlpha;
...
public class Viz implements Grid2D {
     ...
     */
    public Viz(String title, int xPix, int yPix, int xDim, int yDim, boolean active) {
        this.active = active;
        this.xPix = xPix;
        this.yPix = yPix;
        this.xDim = xDim;
     ...
     */
    public Viz(int xPix, int yPix, int xDim, int yDim) {
        this("", xPix, yPix, xDim, yDim, true);
    }
    public Viz(int xPix, int yPix, int xDim, int yDim, boolean active) {
        this("", xPix, yPix, xDim, yDim, active);
    }
    public Viz(String title,int xPix, int yPix, int xDim, int yDim) {
    ...
    private void notifyKeyListeners(int key) {
